	...
	return (
		<main className=' max-w-[100vw]  h-screen'>
			<div className='h-auto relative bg-white '>
				<div className=' right-20 top-[160px] absolute flex-col justify-start items-start flex'>
				...
				<Sidebar />
				<div className='w-full max-w-[1280px] left-[191px] top-[176px] absolute bg-neutral-50'>
