			...
			<div className='shadow-lg pb-8   bg-white'>
				...
				<form className='relative z-[3]  px-6 mt-4 py-6 space-y-8' onSubmit={handleSubmit}>
					<div className='relative'>
						...
						<input type='text' className='appearance-none py-4 w-full border-[1px] border-gray-200 rounded-lg hover:border-black pl-12' placeholder='First and Last name' value={name} onChange={e => setName(e.target.value)} />
					</div>
					<div className='relative'>
						<AiOutlineMail className='absolute  text-2xl top-1/2 left-4 transform -translate-y-1/2' />
						<input type='email' className='appearance-none py-4 w-full border-[1px] border-gray-200 rounded-lg hover:border-black pl-12' placeholder='E-mail' value={email} onChange={e => setEmail(e.target.value)} />
					</div>
					<div className='relative'>
