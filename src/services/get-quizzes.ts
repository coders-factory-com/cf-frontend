export const quizData = [
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description:
          'JavaScript has six primitive types: string, number, bigint, boolean, undefined, and symbol. There is also one special type: null.',
        options: [
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description:
          'To refer to an external JavaScript file in HTML, the <script src=""> tag is used where src attribute contains the path to the JavaScript file.',
        options: [
      ...
      },
      {
        ...
        description:
          'The <!DOCTYPE> declaration is not an HTML tag. It is an information to the browser about what version of HTML the page is written in.',
        options: [
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        description:
          'There are three ways to include CSS in HTML: inline, internal, and external. External CSS is linked using the link tag.',
        options: [
      ...
      },
      {
        ...
        description:
          'A CSS selector is the part of a CSS rule set that selects the HTML element(s) that you want to style.',
        options: [
      ...
      },
      {
        ...
        description:
          'CSS comments are used to explain CSS code, and may help when you edit the source code at a later date. They are ignored by the browser.',
        options: [
