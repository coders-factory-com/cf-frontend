...
export const technologies = [
  {
    ...
    modalContent:
      'JavaScript is a programming language that enables interactive web pages. It is a part of most web browsers and allows client-side script to interact with the user.',
  },
  {
  ...
  },
  {
    ...
    color: 'white',
    modalContent:
      'PHP is a popular server-side scripting language that is used to create dynamic and interactive websites. It is often used in combination with a MySQL database.',
  },
  {
    IconComponent: SiGo,
    backgroundColor: '#0d2137',
    color: '#00acd7',
    modalContent:
      'Go, also known as Golang, is a statically typed, compiled language designed at Google. It is known for its performance and efficiency, and is used for web programming and system applications.',
  },
  {
    ...
    color: 'white',
    modalContent:
      'Swift is a powerful programming language for iOS, macOS, watchOS, and tvOS. It combines performance and development efficiency, and is used for building apps on Apple platforms.',
  },
  {
    IconComponent: FaJava,
    modalContent:
      'Java is a class-based, object-oriented programming language that is designed to have as few implementation dependencies as possible. It is commonly used for mobile applications, web applications, and systems development.',
  },
  {
    ...
    modalContent:
      'HTML5 is the latest version of HTML, the standard markup language for creating web pages. It provides new features, behaviors, and elements that enable more dynamic, interactive web content.',
  },
  {
    ...
    color: '#ab1401',
    modalContent:
      'Ruby is a dynamic, open-source programming language that emphasizes simplicity and productivity. It has an elegant syntax that is easy to read and write, and is used for web development, among other tasks.',
  },
];
